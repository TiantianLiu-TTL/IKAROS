...
public class MinHeap<T> {
    ...
    String piority = "word"; 		// the piority is number of the word that be covered by default
    ...
    private double select1(Stamp s) {
        if (piority.equals("word")) {
            return -s.relScore;
        } else if (piority.equals("distance")) {
            return s.D;
        } else if (piority.equals("rankingscore")) {
            return -s.rankScore;
        } else {
...
//    public void deletek(Stamp s, int k) {
//        ArrayList<Stamp> S = new ArrayList<>();
//        for (int i = 0; i < heapSize; i++) {
//            if (heapArray.get(i).Rp.get(heapArray.get(i).Rp.size() - 1) == s.Rp.get(s.Rp.size() - 1)) {
//                S.add(heapArray.get(i));
//            }
//        }
//        if (S.size() >= k) {
//            for (int = 0; )
