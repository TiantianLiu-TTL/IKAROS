 ...
 *
 */
public class ConnectivityElement {
	 ...
	 * @param mParID
	 */
	public ConnectivityElement(int mDoorID1, int mParID, boolean isPartition, boolean isIn) {
		if (!isPartition) {
	 ...
	 * @param mParID
	 */
	public ConnectivityElement(int mDoorID1, int mDoorID2, int mParID, boolean isPartition, boolean isIn) {
		if (isPartition) {
