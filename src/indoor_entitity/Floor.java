...
public class Floor extends Rect{
	...
	private ConnectivityTier connectivityTier;  // the connectivity tier of this floor
	...
	public void updatemKeywords() {
		...
		for (int i = 0; i < partitionSize; i ++) {
			int[] tempArr = IndoorSpace.iPartitions.get(this.mPartitions.get(i)).getmKeywords();
